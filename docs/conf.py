...
version = django_jwt.__version__
...
html_theme_options = {
    ...
    "fixed_sidebar": True,
    "github_user": "flavors",
    "github_repo": "weenspace-django-jwt",
    "github_banner": True,
    "github_button": True,
    "github_type": "star",
    "sidebar_list": "#e535ab",
...
man_pages = [
    (master_doc, "weenspace-django-jwt", "Django GraphQL JWT Documentation", [author], 1),
]
