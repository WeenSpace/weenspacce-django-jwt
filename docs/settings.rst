...
*Django-graphql-jwt* reads your configuration from a single **Django setting** named ``DJANGO_JWT``::
...
Here's a **list of settings** available in *weenspace-django-jwt* and their default values:
...
~~~~~~~~~~~~~~~~~~
  ...
  .. autofunction:: django_jwt.utils.jwt_encode
...
~~~~~~~~~~~~~~~~~~
  ...
  .. autofunction:: django_jwt.utils.jwt_decode
...
~~~~~~~~~~~~~~~~~~~
  ...
  .. autofunction:: django_jwt.utils.jwt_payload
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  .. autofunction:: django_jwt.utils.get_user_by_natural_key
...
JWT_REFRESH_TOKEN_LONG_RUNNING
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
~~~~~~~~~~~~~~~~~~~~~~~
  ...
  .. autoclass:: django_jwt.refresh_token.models.RefreshToken
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  .. autofunction:: django_jwt.utils.refresh_has_expired
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  .. autofunction:: django_jwt.refresh_token.utils.get_refresh_token_by_model
...
~~~~~~~~~~~~~~~~~~~~~
    ...
    .. autofunction:: django_jwt.middleware.allow_any
