...
from django_jwt.compat import GraphQLResolveInfo
from django_jwt.decorators import jwt_cookie
from django_jwt.settings import jwt_settings
from django_jwt.testcases import JWTClient, JWTTestCase
from django_jwt.utils import jwt_encode, jwt_payload
...
class SchemaTestCase(TestCase, JWTTestCase):
