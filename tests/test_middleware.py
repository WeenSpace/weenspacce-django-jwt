...
from django_jwt.middleware import JWTMiddleware, allow_any
...
class AuthenticateByHeaderTests(TestCase):
    ...
    @override_jwt_settings(JWT_ALLOW_ANY_HANDLER=lambda *args: False)
    @mock.patch("django_jwt.middleware.authenticate", return_value=None)
    ...
    @mock.patch("django_jwt.middleware.authenticate")
